...
var Component = /*#__PURE__*/function (_Nerv$Component) {
...
var PureComponent = /*#__PURE__*/function (_Nerv$PureComponent) {
...
var getRouter = function getRouter() {
  var location = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : taro._$router;
...
var createInnerAudioContext = function createInnerAudioContext() {
  ...
  var simpleEvents = ['Canplay', 'Ended', 'Pause', 'Play', 'Seeked', 'Seeking', 'TimeUpdate', 'Waiting', 'Error'];
...
var createUploadTask = function createUploadTask(_ref) {
  ...
  convertObjectUrlToBlob(filePath).then(function (blob) {
    var tmpFilename = fileName || blob.name || "file-".concat(Date.now()); // 之前这里文件类型是blob，可能丢失信息 这里转换成 File 对象

    var file = new File([blob], tmpFilename, {
      type: blob.type
    });
...
var uploadFile = function uploadFile(_ref2) {
  var url = _ref2.url,
      ...
      withCredentials = _ref2$withCredentials === void 0 ? true : _ref2$withCredentials;
  var task;
  var promise = new Promise(function (resolve, reject) {
...
var chooseImage = function chooseImage(options) {
  ...
  taroChooseImageId.onchange = function (e) {
    var arr = _toConsumableArray(e.target.files).splice(0, count);
...
var ImageContainer = /*#__PURE__*/function (_PureComponent) {
  ...
  function ImageContainer(_props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handlePopState", function () {
...
_defineProperty(WxImageViewer, "propTypes", {
  ...
  onClose: Nerv.PropTypes.func.isRequired,
  // 关闭组件回调
  onError: Nerv.PropTypes.func.isRequired
});
...
var LocationChooser = /*#__PURE__*/function (_Taro$Component) {
  _inherits(LocationChooser, _Taro$Component);

  var _super = _createSuper(LocationChooser);
